...
class Item {
    ...
    Item(int n, vector<ProductionLookahead> pl, Grammar g){
        ...
        while(curr_index < prods.size()){
            ...
            if(prods[curr_index].index < prods[curr_index].rhs.size())
